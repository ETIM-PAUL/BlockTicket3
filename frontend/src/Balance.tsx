            ...
            <div className=" bg-no-repeat p-4 rounded-[8px] min-w-[305px] h-[200px] flex flex-col items-between justify-between bg-gradient-to-r from-[#5522CC] to-[#ED4690]">
                <div className="flex items-center justify-end gap-2 py-1">
                    ...
                    <BsClipboard2Fill
                        ...
                        className="text-white hover:text-blue-400 cursor-pointer text-2xl"
                    />
                </div>
                {reports?.length === 0 && (
                    <span className="sm:text-base grotesk font-bold leading-[25.5px] tracking-[0.085px] mt-4 mb-2 text-xl px-3 text-white">
                        looks like your BlockTicket3 balance is zero! 🙁
                    </span>
                )}
