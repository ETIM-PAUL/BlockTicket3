...
const Footer = () => {
    return (
        <div className="w-[100%] rounded- flex  justify-between items-center md:flex-row flex-col px-20 py-[26.5px] bg-gradient-to-r from-[#5522CC] to-[#ED4690]">
            <p className=" hidden md:flex font-poppins font-normal text-lg text-center text-[#FFFFFF] leading-[27px] ml-1 ">
