...
const StartEventModal = ({ isVisible, onClose, id, setEventDetails, eventDetails, fetchEventDetails }: Props) => {
                    ...
                    <div className=" p-6 rounded">
                        ...
                        <div className="bg-gradient-to-r from-[#5522CC] to-[#ED4690] z-50 mx-auto flex flex-col mt-10 px-4 py-16">
                            ...
                            <div className="flex flex-row mt-1 justify-between gap-4 pt-6">
                                ...
                                {/* Down Vote*/}
                                <div className="flex w-full">
                                    <button onClick={startEvent} disabled={processing} className="disabled:cursor-not-allowed w-full text-lg font-semibold text-center justify-center   bg-gradient-to-r from-[#5522CC] to-[#8352f5]  text-white hover:bg-gradient-to-r hover:from-[#9a8abd] hover:to-[#5946ed] hover:text-[#FFFFFF]">
