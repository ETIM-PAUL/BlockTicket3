...
const BuyTicketModal = ({ isVisible, onClose, tickets, id, organizer, fetchEventDetails }: Props) => {
    ...
    const purchaseTicket = async (ticket_details: any) => {
        ...
        if (rollups) {
            ...
            try {
                ...
                toast.error("Event ticket purchased successfully")
                setProcessing(false);
                fetchEventDetails();
                onClose();
            } catch (error) {
