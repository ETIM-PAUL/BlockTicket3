        ...
        <div className="h-full flex flex-col">
            ...
            <div className="bg-base-100 p-8 bg-gradient-to-l from-[#5522CC] to-[#ED4690]">
                <div className="flex items-center md:mx-14 flex-row gap-2 md:gap-4 justify-start md:justify-end md:mt-6 ">
                    <button
                        className={`py-2 px-4 rounded-md border border-bg-[#EEE1FF] w-fit items-center text-center flex  justify-center font-medium text-lg ${
                    ...
                    <button
                        className={`py-2 px-4 rounded-md border border-bg-[#EEE1FF] items-center text-center flex w-fit justify-center font-medium text-lg ${
                    ...
                    <button
                        className={`py-2 px-4 w-[200px] rounded-md border border-bg-[#EEE1FF] items-center text-center flex justify-center font-medium text-lg ${
